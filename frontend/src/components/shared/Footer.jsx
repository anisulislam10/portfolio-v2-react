...
function Footer({showNavbar = true}) {
  return (
    <div>
      <div className='grid grid-cols-3 mt-7 content-center text-center bg-blue-400 text-white px-[70px]'>

        <div>
          <h1 className='font-semibold text-[20px] underline'>Quick Links</h1>
          <ul className='text-start mt-4  ml-[130px]'>
        ...
        <div>
          ...
          <ul className='text-start mt-4 ml-[150px]'>
        ...
        <div >
          <h1 className='font-semibold text-[20px] underline'>Follow </h1>
          <ul className='text-start mt-4  ml-[150px]'>
